import { configManager, logger, isValidProvider, getProviderDisplayName } from '../core/index.js';
import type { OpitoConfig, Provider } from '../core/index.js';
...
export async function setBaseCommand(
  ...
  if (!isValidProvider(provider)) {
    ...
    logger.info('Valid providers: claude, opencode, droid');
    process.exit(1);
  }
