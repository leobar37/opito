import { BackupManager, logger, promptForSyncOptions, getProviderPaths, createParser, createConverter, getDefaultTarget, isValidProvider, isValidScope, SyncEngine } from '@opito/core';
import type { CopilotPromptConfig, ParserInstance } from '@opito/core';
import type {
  SyncOptions,
  SyncResult,
  SyncReport,
