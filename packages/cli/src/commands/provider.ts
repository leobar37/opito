...
import { profileExists, getProfile, createDefaultProfile, saveProfile, listProfiles, getDefaultProfiles, logger, withLoader } from '@opito/core';
import { configureClaudeForProfile } from '../writers/claude-writer.js';
import { configureDroidForProfile } from '../writers/droid-writer.js';
import type { ProviderType, CliType, Profile } from '@opito/core';
