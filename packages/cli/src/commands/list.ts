import { ClaudeParser, OpencodeParser, logger } from "../core/index.js";
import type { CommandConfig } from "../core/index.js";
...
export async function listCommand(
  config: {
    claude: { commandsPath: string };
    opencode: { commandsPath: string };
  },
